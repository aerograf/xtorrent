    ...
    default:
        ...
        $adminObject -> displayNavigation(basename(__FILE__));
      	...
      	echo "<fieldset><legend style='font-weight: bold; color: #900;'>" . _AM_XTORRENT_SUB_FILESWAITINGINFO . "</legend>
              ...
              <ul>
              <li style='padding:4px;'><b>" . _AM_XTORRENT_SUB_FILESWAITINGVALIDATION . '</b> ' . $new_array_count . "</li>
          		<li style='padding:4px;'>" . $imagearray['approve'] . ' ' . _AM_XTORRENT_SUB_APPROVEWAITINGFILE . "</li>
          		<li style='padding:4px;'>" . $imagearray['editimg'] . ' ' . _AM_XTORRENT_SUB_EDITWAITINGFILE . "</li>
          		<li style='padding:4px;'>" . $imagearray['deleteimg'] . ' ' . _AM_XTORRENT_SUB_DELETEWAITINGFILE . "</li>
              </ul></div>
