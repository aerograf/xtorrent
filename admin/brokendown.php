    ...
    case "default":
        ...
        $adminObject -> displayNavigation(basename(__FILE__));
      	...
      	echo "<fieldset><legend style='font-weight:bold;color:#900;'>" . _AM_XTORRENT_BROKEN_REPORTINFO . "</legend>
          		<div>
          		<ul>
              <li style='padding:4px;'><b>" . _AM_XTORRENT_BROKEN_REPORTSNO . "</b> " . $totalbrokendownloads . "</li>
              <li style='padding:4px;'>" . $imagearray['ignore'] . " " . _AM_XTORRENT_BROKEN_IGNOREDESC . "</li>
          		<li style='padding:4px;'>" . $imagearray['editimg'] . " " . _AM_XTORRENT_BROKEN_EDITDESC . "</li>
          		<li style='padding:4px;'>" . $imagearray['deleteimg'] . " " . _AM_XTORRENT_BROKEN_DELETEDESC . "</li>
          		<li style='padding:4px;'>" . $imagearray['ack_yes'] . " " . _AM_XTORRENT_BROKEN_ACKDESC . "</li>
          		<li style='padding:4px;'>" . $imagearray['con_yes'] . " " . _AM_XTORRENT_BROKEN_CONFIRMDESC . "</li>
          		</ul></div><br>
        ...
        else
        {
            ...
            {
                $result2 = $xoopsDB->query("SELECT cid, title, url, submitter FROM "
                ...
                else
                {
              	...
              	echo "</td>
                    	...
                    	echo "<a href='brokendown.php?op=updateNotice&amp;lid=" . $lid . "&ack=" . $acknowledged . "' title='" . _AM_XTORRENT_BROKEN_ACKDESC . "'>" . $ack_image . " </a>";
                    	$con_image = ($confirmed) ? $imagearray['con_yes'] : $imagearray['con_no'];
                    	echo "<a href='brokendown.php?op=updateNotice&amp;lid=" . $lid . "&amp;con=" . $confirmed . "' title='" . _AM_XTORRENT_BROKEN_CONFIRMDESC . "'>" . $con_image . " </a>
                            </td></tr>";
            } 
        } 
        echo"</table></fieldset>";
