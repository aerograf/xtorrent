...
function payments()
{
    ...
    if ($pageNum_recset1 > 0) {
        echo '<td><form action="index.php#AdminTop" method="post">'
             ...
             . '<input type="hidden" name="totalRows_recset1" value="'
             . $totalRows_recset1
             . '">'
             . '<input type="submit" name="navig" value="|&lt;" title="Current"></form></td>';
        echo '<td><form action="index.php#AdminTop" method="post">'
             . '<input type="hidden" name="op" value="payment">'
             . '<input type="hidden" name="pageNum_recset1" value="'
             . max(0, $pageNum_recset1 - 1)
             . '">'
             . '<input type="hidden" name="totalRows_recset1" value="'
             . $totalRows_recset1
             . '">'
    ...
    if ($pageNum_recset1 < $totalPages_recset1) {
        echo '<td><form action="index.php#AdminTop" method="post">'
             . '<input type="hidden" name="op" value="payment">'
             . '<input type="hidden" name="pageNum_recset1" value="'
             . min($totalPages_recset1, $pageNum_recset1 + 1)
             . '">'
             . '<input type="hidden" name="totalRows_recset1" value="'
             . $totalRows_recset1
             . '">'
    ...
    echo "<table style='width:100%; text-align:left;'><tr>"
         ...
         . _AM_XTORRENT_PAYPAL_IPN_DATE
         . '</th>'
         . "<th style='text-align:left;'>"
         . _AM_XTORRENT_PAYPAL_IPN_NUM
         . '</th>'
         . "<th style='text-align:left;'>"
         . _AM_XTORRENT_PAYPAL_IPN_NAME
         . '</th>'
         . "<th style='text-align:left;'>"
         . _AM_XTORRENT_PAYPAL_IPN_DESC
         . '</th>'
         . "<th style='text-align:left;'>"
         . _AM_XTORRENT_PAYPAL_IPN_AMOUNT
         . '</th>'
         . '</tr><tr>';
    ...
    do {
        ...
        if (0 != $numRec) {
            echo '<a href="javascript: void 0" onclick="'
                 . "document.recedit.id.value = '"
                 . $row_recset1['id']
                 . "'; "
                 . "document.recedit.StartMonth.value = '"
                 . $row_recset1['mon']
                 . "'; "
                 . "document.recedit.StartDay.value = '"
                 . $row_recset1['day']
                 . "'; "
                 . "document.recedit.StartYear.value = '"
                 . $row_recset1['year']
                 . "'; "
                 . "document.recedit.Num.value = '"
                 . $row_recset1['num']
                 . "'; "
                 . "document.recedit.Name.value = '"
                 . $row_recset1['name']
                 . "'; "
                 . "document.recedit.Descr.value = '"
                 . $row_recset1['descr']
                 . "'; "
                 . "document.recedit.Amount.value = '"
                 . $row_recset1['amount']
                 . "'; "
                 . "document.recedit.Submit.value = '"
                 . _AM_XTORRENT_PAYPAL_IPN_MODIFY
                 . "'; "
                 . "document.recedit.op.value = '"
                 . _AM_XTORRENT_PAYPAL_IPN_FRE
                 . "'; "
                 . 'return false;">'
                 . "<img style='width:12px; height:13px' src='../assets/images/admin/treasury_edit.png'></a>&nbsp;"
                 . "<a href='index.php?op=FinRegDel&id="
                 . $row_recset1['id']
                 . "'>"
                 . "<img style='width:12px; height:13px' src='../assets/images/admin/treasury_drop.png' onClick=\"return confirm('"
                 . _AM_XTORRENT_PAYPAL_IPN_DEL_1
                 . ''
                 . '\n\n'
                 . ''
