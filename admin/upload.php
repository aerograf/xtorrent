...
switch ($op)
{
    ...
    default:
        ...
        $namearray = [
                      1 => _AM_XTORRENT_DOWN_CATIMAGE,
                      2 => _AM_XTORRENT_DOWN_SCREENSHOTS,
                      3 => _AM_XTORRENT_DOWN_MAINIMAGEDIR
                      ];
        $listarray = [
                      1 => _AM_XTORRENT_DOWN_FCATIMAGE,
                      2 => _AM_XTORRENT_DOWN_FSCREENSHOTS,
                      3 => _AM_XTORRENT_DOWN_FMAINIMAGEDIR
                      ];

        $adminObject = \Xmf\Module\Admin::getInstance();
        $adminObject -> displayNavigation(basename(__FILE__));
        
	      echo "<fieldset><legend style='font-weight:bold; color:#900;'>" . _AM_XTORRENT_MUPLOADS . "</legend>";
