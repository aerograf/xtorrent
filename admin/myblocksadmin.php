...
{
    if (strstr($def , '_AM_XTORRENT_ACCESSRIGHTS') || strstr($def , '_AM_XTORRENT_ACTIVERIGHTS')) eval($def);
}
// check $xoopsModule
...
function list_blocks()
{
    ...
    $side_descs = [
                   0 => _AM_XTORRENT_SBLEFT,
                   1 => _AM_XTORRENT_SBRIGHT,
                   3 => _AM_XTORRENT_CBLEFT,
                   4 => _AM_XTORRENT_CBRIGHT,
                   5 => _AM_XTORRENT_CBCENTER
                   ]; 
    // displaying TH
    echo "<table class='outer' style='width:99%'>
	        <tr valign='middle'>";
    $headingarray = [
