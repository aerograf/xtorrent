...
class XtorrentSoap_catmatchHandler extends XoopsObjectHandler {
	var $db;
	var $db_table;
	var $perm_name = 'xtorrent_soap_catmatch_';
	var $obj_class = 'soap_catmatchResource';
	...
	function insert($soap_catmatch, $force = false){
	...
	function getPermittedTorrents($soap_catmatch, $mode = "view"){
