...
class XtorrentReviewHandler extends XoopsObjectHandler {
	var $db;
	var $db_table;
	var $perm_name = 'xtorrent_review_';
	var $obj_class = 'reviewResource';
	...
	function insert($review, $force = false){
		global $myts;
	...
	function getObjects($criteria = null, $fields='*', $reviewid_as_key = false){
		$ret = array();
		$limit = $start = 0;
	...
	function deleteTorrentPermissions($reviewid, $mode = "view"){
		global $xoopsModule;
	...
	function insertTorrentPermissions($reviewid, $group_ids, $mode = "view"){
		global $xoopsModule;
	...
	function getPermittedTorrents($review, $mode = "view"){
	...
	function getSingleTorrentPermission($reviewid, $mode = "view"){
		global $xoopsUser, $xoopsModule;
		$groups = is_object($xoopsUser) ? $xoopsUser->getGroups() : 3;
