...
class XtorrentTorrentHandler extends XoopsObjectHandler {
	var $db;
	var $db_table;
	var $perm_name = 'xtorrent_torrent_';
	var $obj_class = 'torrentResource';
	...
	function insert($torrent, $force = false){
	...
	function getPermittedTorrents($torrent, $mode = "view"){
