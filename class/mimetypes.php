...
class XtorrentMimetypesHandler extends XoopsObjectHandler {
	var $db;
	var $db_table;
	var $perm_name = 'xtorrent_mimetypes_';
	var $obj_class = 'mimetypesResource';
	...
	function insert($mimetypes, $force = false){
	...
	function getObjects($criteria = null, $fields='*', $mime_id_as_key = false){
		$ret   = [];
		$limit = $start = 0;
	...
	function deleteTorrentPermissions($mime_id, $mode = "view"){
		global $xoopsModule;
	...
	function insertTorrentPermissions($mime_id, $group_ids, $mode = "view"){
		global $xoopsModule;
	...
	function &getPermittedTorrents($mimetypes, $mode = "view"){
	...
	function getSingleTorrentPermission($mime_id, $mode = "view"){
		global $xoopsUser, $xoopsModule;
		$groups = is_object($xoopsUser) ? $xoopsUser->getGroups() : 3;
