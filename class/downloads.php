...
class XtorrentDownloadsHandler extends XoopsObjectHandler {
	var $db;
	var $db_table;
	var $perm_name = 'xtorrent_downloads_';
	var $obj_class = 'downloadsResource';
	...
	function getObjects($criteria = null, $fields='*', $lid_as_key = false){
		$ret   = [];
		$limit = $start = 0;
	...
	function getPermittedTorrents($downloads, $mode = "view"){
