    ...
    public function insert($soap_transactions, $force = false)
    {
        ...
        if ($soap_transactions->isNew() || empty($id)) {
            ...
            $sql = sprintf('INSERT INTO %s (
				...
				%u, %s, %s, %s, %s, %s, %s
				)', $this->db_table, $this->db->quoteString($lid), $this->db->quoteString($cid), $this->db->quoteString($slid), $this->db->quoteString($scid), $this->db->quoteString($scrc), $this->db->quoteString($retrieved), $this->db->quoteString($ssitename), $this->db->quoteString($surl));
        } else {
