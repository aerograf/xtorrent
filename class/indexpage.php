...
class XtorrentIndexpageHandler extends XoopsObjectHandler {
	var $db;
	var $db_table;
	var $perm_name = 'xtorrent_indexpage_';
	var $obj_class = 'indexpageResource';
	...
	function insert($indexpage, $force = false){
	...
	function getPermittedTorrents($indexpage, $mode = "view"){
