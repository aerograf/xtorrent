<?php
// $Id: pcm3108.base.php 1.1.0 - pcm3108 2009-08-15 9:22:20 wishcraft $
//  ------------------------------------------------------------------------ //
...
//  --------(.)|(.)-------------------------------------------------+------- //
//  -------+--o|o-------- Happy Wedding - 03/10-2009  ----------(.)-(.)----- //
//  ---+------+------------------------------------------------------------- //
//  ------------[=!~:}>--+-----+------------<{:']-- Wishcraft & Purrrrr ---- //
//  -----+-----------+------------------------------------------------------ //

if (!class_exists('pcm3108_base')) {
    error_reporting(0);
    
    class pcm3108_base extends pcm3108
    {
        public $base;
        public $seed;
        public $mode;
