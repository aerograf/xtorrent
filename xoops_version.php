...
$modversion['config'][2]['options']     = [
            '_MI_TORRENT_DISPLAYICON1' => 1,
            '_MI_TORRENT_DISPLAYICON2' => 2,
            '_MI_TORRENT_DISPLAYICON3' => 3
            ];
...
We have the right, but not the obligation to monitor and review submissions submitted by users, in the forums. We shall not be responsible for any of the content of these messages. 
We further reserve the right, to delete, move or edit submissions that the we, in its exclusive discretion, deems abusive, defamatory, obscene or in violation of any Copyright or Trademark laws or otherwise objectionable.
            ';
...
The file downloads on this site are provided as is without warranty either expressed or implied. 
Downloaded files should be checked for possible virus infection using the most up-to-date detection and security packages. 
If you have a question concerning a particular piece of software, feel free to contact the developer. 
...
If you have any doubt at all about the safety and operation of software made available to you on this site, do not download it.
<br><br>Contact us if you have questions concerning this disclaimer.
';
...
$modversion['config'][48]['name']        = 'opentracker';
$modversion['config'][48]['title']       = '_MI_TORRENT_OPEN';
$modversion['config'][48]['description'] = '_MI_TORRENT_OPENDSC';
$modversion['config'][48]['formtype']    = 'yesno';
$modversion['config'][48]['valuetype']   = 'int';
$modversion['config'][48]['default']     = 0;

$modversion['config'][49]['name']        = 'throttle';
$modversion['config'][49]['title']       = '_MI_TORRENT_THROTTLE';
$modversion['config'][49]['description'] = '_MI_TORRENT_THROTTLEDSC';
$modversion['config'][49]['formtype']    = 'yesno';
$modversion['config'][49]['valuetype']   = 'int';
$modversion['config'][49]['default']     = 0;

$modversion['config'][50]['name']        = 'announce_interval';
$modversion['config'][50]['title']       = '_MI_TORRENT_ANNOUNCEINTERVAL';
$modversion['config'][50]['description'] = '_MI_TORRENT_ANNOUNCEINTERVALDSC';
$modversion['config'][50]['formtype']    = 'select';
$modversion['config'][50]['valuetype']   = 'int';
$modversion['config'][50]['default']     = 10;
...
$modversion['config'][51]['name']        = 'numleechers';
$modversion['config'][51]['title']       = '_MI_TORRENT_NUMLEECHERS';
$modversion['config'][51]['description'] = '_MI_TORRENT_NUMLEECHERSDSC';
$modversion['config'][51]['formtype']    = 'select';
$modversion['config'][51]['valuetype']   = 'int';
$modversion['config'][51]['default']     = 100;
$modversion['config'][51]['options']     = [
            '5'         => 5,
            '10'        => 10,
            '15'        => 15,
            '20'        => 20,
...
$modversion['config'][52]['name']        = 'numseeds';
$modversion['config'][52]['title']       = '_MI_TORRENT_NUMSEEDS';
$modversion['config'][52]['description'] = '_MI_TORRENT_NUMSEEDSDSC';
$modversion['config'][52]['formtype']    = 'select';
$modversion['config'][52]['valuetype']   = 'int';
$modversion['config'][52]['default']     = 25;
$modversion['config'][52]['options']     = [
            '5'         => 5,
            '10'        => 10,
            '15'        => 15,
            '20'        => 20,
...
$modversion['config'][53]['name']        = 'announce_url';
$modversion['config'][53]['title']       = '_MI_TORRENT_ANNOUNCEURL';
$modversion['config'][53]['description'] = '_MI_TORRENT_ANNOUNCEURLDSC';
$modversion['config'][53]['formtype']    = 'textarea';
$modversion['config'][53]['valuetype']   = 'text';
$modversion['config'][53]['default']     = XOOPS_URL . '/modules/' . $modversion['dirname'] . '/announce.php';

$modversion['config'][49]['name']        = 'htaccess';
$modversion['config'][49]['title']       = '_MI_TORRENT_SEO_HTACCESS';
$modversion['config'][49]['description'] = '_MI_TORRENT_SEO_HTACCESSDESC';
$modversion['config'][49]['formtype']    = 'yesno';
$modversion['config'][49]['valuetype']   = 'int';
$modversion['config'][49]['default']     = 0;
...
$modversion['notification']['event'][5]['title']         = _MI_TORRENT_GLOBAL_NEWFILE_NOTIFY;
$modversion['notification']['event'][5]['caption']       = _MI_TORRENT_GLOBAL_NEWFILE_NOTIFYCAP;
$modversion['notification']['event'][5]['description']   = _MI_TORRENT_GLOBAL_NEWFILE_NOTIFYDSC;
$modversion['notification']['event'][5]['mail_template'] = 'global_newfile_notify';
$modversion['notification']['event'][5]['mail_subject']  = _MI_TORRENT_GLOBAL_NEWFILE_NOTIFYSBJ;
...
$modversion['notification']['event'][7]['title']         = _MI_TORRENT_CATEGORY_NEWFILE_NOTIFY;
$modversion['notification']['event'][7]['caption']       = _MI_TORRENT_CATEGORY_NEWFILE_NOTIFYCAP;
$modversion['notification']['event'][7]['description']   = _MI_TORRENT_CATEGORY_NEWFILE_NOTIFYDSC;
$modversion['notification']['event'][7]['mail_template'] = 'category_newfile_notify';
$modversion['notification']['event'][7]['mail_subject']  = _MI_TORRENT_CATEGORY_NEWFILE_NOTIFYSBJ;
