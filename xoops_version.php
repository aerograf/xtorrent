...
$modversion['warning'] = _MI_XTORRENT_WARNINGTEXT;
$modversion['author_credits'] = _MI_XTORRENT_AUTHOR_CREDITSTEXT;
*/

// Blocks
$modversion['blocks'][] = [
    'file'        => 'xtorrent_top.php',
    'name'        => _MI_XTORRENT_BNAME1,
...
if ($submissions) {
    $i++;
    $modversion['sub'][$i]['name'] = _MI_XTORRENT_SMNAME1;
    $modversion['sub'][$i]['url']  = 'submit.php';
}
$i++;
$modversion['sub'][$i]['name'] = _MI_XTORRENT_SMNAME2;
$modversion['sub'][$i]['url']  = 'topten.php?list=hit';
$i++;
$modversion['sub'][$i]['name'] = _MI_XTORRENT_SMNAME3;
...
$modversion['config'][1]['title']       = '_MI_XTORRENT_POPULAR';
$modversion['config'][1]['description'] = '_MI_XTORRENT_POPULARDSC';
...
$modversion['config'][2]['title']       = '_MI_XTORRENT_ICONDISPLAY';
$modversion['config'][2]['description'] = '_MI_XTORRENT_DISPLAYICONDSC';
$modversion['config'][2]['formtype']    = 'select';
$modversion['config'][2]['valuetype']   = 'int';
$modversion['config'][2]['default']     = 1;
$modversion['config'][2]['options']     = ['_MI_XTORRENT_DISPLAYICON1' => 1, '_MI_XTORRENT_DISPLAYICON2' => 2, '_MI_XTORRENT_DISPLAYICON3' => 3];

$modversion['config'][3]['name']        = 'perpage';
$modversion['config'][3]['title']       = '_MI_XTORRENT_PERPAGE';
$modversion['config'][3]['description'] = '_MI_XTORRENT_PERPAGEDSC';
...
$modversion['config'][35]['title']       = '_MI_XTORRENT_ADMINPAGE';
$modversion['config'][35]['description'] = '_MI_XTORRENT_AMDMINPAGEDSC';
...
$modversion['config'][39]['title']       = '_MI_XTORRENT_ARTICLESSORT';
$modversion['config'][39]['description'] = '_MI_XTORRENT_ARTICLESSORTDSC';
...
$modversion['config'][39]['options']     = [
    _MI_XTORRENT_TITLE . $qa      => 'title ASC',
    _MI_XTORRENT_TITLE . $qd      => 'title DESC',
    _MI_XTORRENT_SUBMITTED2 . $qa => 'published ASC',
    _MI_XTORRENT_SUBMITTED2 . $qd => 'published DESC',
    _MI_XTORRENT_RATING . $qa     => 'rating ASC',
    _MI_XTORRENT_RATING . $qd     => 'rating DESC',
    _MI_XTORRENT_POPULARITY . $qa => 'hits ASC',
    _MI_XTORRENT_POPULARITY . $qd => 'hits DESC',
    _MI_XTORRENT_WEIGHT           => 'weight'
];

$modversion['config'][32]['name']        = 'subcats';
$modversion['config'][32]['title']       = '_MI_XTORRENT_SUBCATS';
$modversion['config'][32]['description'] = '_MI_XTORRENT_SUBCATSDSC';
...
$modversion['config'][41]['title']       = '_MI_XTORRENT_DAYSNEW';
$modversion['config'][41]['description'] = '_MI_XTORRENT_DAYSNEWDSC';
...
$modversion['config'][42]['title']       = '_MI_XTORRENT_DAYSUPDATED';
$modversion['config'][42]['description'] = '_MI_XTORRENT_DAYSUPDATEDDSC';
...
$modversion['config'][6]['title']       = '_MI_XTORRENT_USESHOTS';
$modversion['config'][6]['description'] = '_MI_XTORRENT_USESHOTSDSC';
$modversion['config'][6]['formtype']    = 'yesno';
$modversion['config'][6]['valuetype']   = 'int';
$modversion['config'][6]['default']     = 0;

$modversion['config'][21]['name']        = 'usethumbs';
$modversion['config'][21]['title']       = '_MI_XTORRENT_USETHUMBS';
$modversion['config'][21]['description'] = '_MI_XTORRENT_USETHUMBSDSC';
...
$modversion['config'][36]['title']       = '_MI_XTORRENT_IMGUPDATE';
$modversion['config'][36]['description'] = '_MI_XTORRENT_IMGUPDATEDSC';
...
$modversion['config'][37]['title']       = '_MI_XTORRENT_QUALITY';
$modversion['config'][37]['description'] = '_MI_XTORRENT_QUALITYDSC';
...
$modversion['config'][38]['title']       = '_MI_XTORRENT_KEEPASPECT';
$modversion['config'][38]['description'] = '_MI_XTORRENT_KEEPASPECTDSC';
...
$modversion['config'][7]['title']       = '_MI_XTORRENT_SHOTWIDTH';
$modversion['config'][7]['description'] = '_MI_XTORRENT_SHOTWIDTHDSC';
$modversion['config'][7]['formtype']    = 'textbox';
$modversion['config'][7]['valuetype']   = 'int';
$modversion['config'][7]['default']     = 140;

$modversion['config'][20]['name']        = 'shotheight';
$modversion['config'][20]['title']       = '_MI_XTORRENT_SHOTHEIGHT';
$modversion['config'][20]['description'] = '_MI_XTORRENT_SHOTHEIGHTDSC';
...
$modversion['config'][8]['title']       = '_MI_XTORRENT_CHECKHOST';
...
$modversion['config'][9]['title']       = '_MI_XTORRENT_REFERERS';
$modversion['config'][9]['description'] = '_MI_XTORRENT_REFERERSDSC';
...
$modversion['config'][15]['title']       = '_MI_XTORRENT_ALLOWSUBMISS';
$modversion['config'][15]['description'] = '_MI_XTORRENT_ALLOWSUBMISSDSC';
...
$modversion['config'][34]['title']       = '_MI_XTORRENT_SUBMITART';
$modversion['config'][34]['description'] = '_MI_XTORRENT_SUBMITARTDSC';
...
$modversion['config'][4]['title']       = '_MI_XTORRENT_ANONPOST';
$modversion['config'][4]['description'] = '_MI_XTORRENT_ANONPOSTDSC';
$modversion['config'][4]['formtype']    = 'yesno';
$modversion['config'][4]['valuetype']   = 'int';
$modversion['config'][4]['default']     = 0;

$modversion['config'][5]['name']        = 'autoapprove';
$modversion['config'][5]['title']       = '_MI_XTORRENT_AUTOAPPROVE';
$modversion['config'][5]['description'] = '_MI_XTORRENT_AUTOAPPROVEDSC';
$modversion['config'][5]['formtype']    = 'yesno';
$modversion['config'][5]['valuetype']   = 'int';
$modversion['config'][5]['default']     = 0;

$modversion['config'][16]['name']        = 'useruploads';
$modversion['config'][16]['title']       = '_MI_XTORRENT_ALLOWUPLOADS';
$modversion['config'][16]['description'] = '_MI_XTORRENT_ALLOWUPLOADSDSC';
...
$modversion['config'][10]['title']       = '_MI_XTORRENT_MAXFILESIZE';
$modversion['config'][10]['description'] = '_MI_XTORRENT_MAXFILESIZEDSC';
$modversion['config'][10]['formtype']    = 'textbox';
$modversion['config'][10]['valuetype']   = 'int';
$modversion['config'][10]['default']     = 200000;

$modversion['config'][11]['name']        = 'maximgwidth';
$modversion['config'][11]['title']       = '_MI_XTORRENT_IMGWIDTH';
$modversion['config'][11]['description'] = '_MI_XTORRENT_IMGWIDTHDSC';
$modversion['config'][11]['formtype']    = 'textbox';
$modversion['config'][11]['valuetype']   = 'int';
$modversion['config'][11]['default']     = 600;

$modversion['config'][12]['name']        = 'maximgheight';
$modversion['config'][12]['title']       = '_MI_XTORRENT_IMGHEIGHT';
$modversion['config'][12]['description'] = '_MI_XTORRENT_IMGHEIGHTDSC';
$modversion['config'][12]['formtype']    = 'textbox';
$modversion['config'][12]['valuetype']   = 'int';
$modversion['config'][12]['default']     = 600;

$modversion['config'][13]['name']        = 'uploaddir';
$modversion['config'][13]['title']       = '_MI_XTORRENT_UPLOADDIR';
$modversion['config'][13]['description'] = '_MI_XTORRENT_UPLOADDIRDSC';
...
$modversion['config'][19]['title']       = '_MI_XTORRENT_MAINIMGDIR';
$modversion['config'][19]['description'] = '_MI_XTORRENT_MAINIMGDIRDSC';
...
$modversion['config'][17]['title']       = '_MI_XTORRENT_SCREENSHOTS';
$modversion['config'][17]['description'] = '_MI_XTORRENT_SCREENSHOTSDSC';
...
$modversion['config'][18]['title']       = '_MI_XTORRENT_CATEGORYIMG';
$modversion['config'][18]['description'] = '_MI_XTORRENT_CATEGORYIMGDSC';
...
$modversion['config'][26]['title']       = '_MI_XTORRENT_PLATFORM';
$modversion['config'][26]['description'] = '_MI_XTORRENT_PLATFORMDSC';
...
$modversion['config'][27]['title']       = '_MI_XTORRENT_LICENSE';
$modversion['config'][27]['description'] = '_MI_XTORRENT_LICENSEDSC';
...
$modversion['config'][33]['title']       = '_MI_XTORRENT_VERSIONTYPES';
$modversion['config'][33]['description'] = '_MI_XTORRENT_PLATFORMDSC';
...
$modversion['config'][31]['title']       = '_MI_XTORRENT_LIMITS';
$modversion['config'][31]['description'] = '_MI_XTORRENT_LIMITSDSC';
...
$modversion['config'][23]['title']       = '_MI_XTORRENT_DATEFORMAT';
$modversion['config'][23]['description'] = '_MI_XTORRENT_DATEFORMATDSC';
...
$modversion['config'][24]['title']       = '_MI_XTORRENT_SHOWDISCLAIMER';
$modversion['config'][24]['description'] = '_MI_XTORRENT_SHOWDISCLAIMERDSC';
...
$modversion['config'][25]['title']       = '_MI_XTORRENT_DISCLAIMER';
$modversion['config'][25]['description'] = '_MI_XTORRENT_DISCLAIMERDSC';
...
$modversion['config'][29]['title']       = '_MI_XTORRENT_SHOWDOWNDISCL';
$modversion['config'][29]['description'] = '_MI_XTORRENT_SHOWDOWNDISCLDSC';
...
$modversion['config'][30]['title']       = '_MI_XTORRENT_DOWNDISCLAIMER';
$modversion['config'][30]['description'] = '_MI_XTORRENT_DOWNDISCLAIMERDSC';
...
$modversion['config'][40]['title']       = '_MI_XTORRENT_COPYRIGHT';
$modversion['config'][40]['description'] = '_MI_XTORRENT_COPYRIGHTDSC';
...
$modversion['config'][43]['title']       = '_MI_XTORRENT_POLL_TORRENT';
$modversion['config'][43]['description'] = '_MI_XTORRENT_POLL_TORRENTDSC';
...
$modversion['config'][44]['title']       = '_MI_XTORRENT_POLL_TORRENTTIME';
$modversion['config'][44]['description'] = '_MI_XTORRENT_POLL_TORRENTTIMEDSC';
...
$modversion['config'][45]['title']       = '_MI_XTORRENT_POLL_TRACKER';
$modversion['config'][45]['description'] = '_MI_XTORRENT_POLL_TRACKERDSC';
...
$modversion['config'][46]['title']       = '_MI_XTORRENT_POLL_TRACKERTIME';
$modversion['config'][46]['description'] = '_MI_XTORRENT_POLL_TRACKERTIMEDSC';
...
$modversion['config'][47]['title']       = '_MI_XTORRENT_POLL_TRACKERTIMEOUT';
$modversion['config'][47]['description'] = '_MI_XTORRENT_POLL_TRACKERTIMEOUTDSC';
...
$modversion['config'][48]['title']       = '_MI_XTORRENT_ANNOUNCEINTERVAL';
$modversion['config'][48]['description'] = '_MI_XTORRENT_ANNOUNCEINTERVALDSC';
...
$modversion['config'][49]['title']       = '_MI_XTORRENT_NUMLEECHERS';
$modversion['config'][49]['description'] = '_MI_XTORRENT_NUMLEECHERSDSC';
...
$modversion['config'][50]['title']       = '_MI_XTORRENT_NUMSEEDS';
$modversion['config'][50]['description'] = '_MI_XTORRENT_NUMSEEDSDSC';
...
$modversion['config'][51]['title']       = '_MI_XTORRENT_ANNOUNCEURL';
$modversion['config'][51]['description'] = '_MI_XTORRENT_ANNOUNCEURLDSC';
...
$modversion['config'][52]['title']       = '_MI_XTORRENT_AGENTSDISALLOWED';
$modversion['config'][52]['description'] = '_MI_XTORRENT_AGENTSDISALLOWEDDESC';
...
$modversion['config'][55]['title']       = '_MI_XTORRENT_CURRENCIES';
$modversion['config'][55]['description'] = '_MI_XTORRENT_CURRENCIESDESC';
...
$modversion['config'][60]['title']       = '_MI_XTORRENT_SEO_HTACCESS';
$modversion['config'][60]['description'] = '_MI_XTORRENT_SEO_HTACCESSDESC';
...
$modversion['config'][66]['title']       = '_MI_XTORRENT_HASHKEYS';
$modversion['config'][66]['description'] = '_MI_XTORRENT_HASHKEYSDSC';
...
$modversion['notification']['category'][1]['title']          = _MI_XTORRENT_GLOBAL_NOTIFY;
$modversion['notification']['category'][1]['description']    = _MI_XTORRENT_GLOBAL_NOTIFYDSC;
...
$modversion['notification']['category'][2]['title']          = _MI_XTORRENT_CATEGORY_NOTIFY;
$modversion['notification']['category'][2]['description']    = _MI_XTORRENT_CATEGORY_NOTIFYDSC;
...
$modversion['notification']['category'][3]['title']          = _MI_XTORRENT_FILE_NOTIFY;
$modversion['notification']['category'][3]['description']    = _MI_XTORRENT_FILE_NOTIFYDSC;
...
$modversion['notification']['event'][1]['title']         = _MI_XTORRENT_GLOBAL_NEWCATEGORY_NOTIFY;
$modversion['notification']['event'][1]['caption']       = _MI_XTORRENT_GLOBAL_NEWCATEGORY_NOTIFYCAP;
$modversion['notification']['event'][1]['description']   = _MI_XTORRENT_GLOBAL_NEWCATEGORY_NOTIFYDSC;
$modversion['notification']['event'][1]['mail_template'] = 'global_newcategory_notify';
$modversion['notification']['event'][1]['mail_subject']  = _MI_XTORRENT_GLOBAL_NEWCATEGORY_NOTIFYSBJ;

$modversion['notification']['event'][2]['name']          = 'file_modify';
$modversion['notification']['event'][2]['category']      = 'global';
$modversion['notification']['event'][2]['admin_only']    = 1;
$modversion['notification']['event'][2]['title']         = _MI_XTORRENT_GLOBAL_FILEMODIFY_NOTIFY;
$modversion['notification']['event'][2]['caption']       = _MI_XTORRENT_GLOBAL_FILEMODIFY_NOTIFYCAP;
$modversion['notification']['event'][2]['description']   = _MI_XTORRENT_GLOBAL_FILEMODIFY_NOTIFYDSC;
$modversion['notification']['event'][2]['mail_template'] = 'global_filemodify_notify';
$modversion['notification']['event'][2]['mail_subject']  = _MI_XTORRENT_GLOBAL_FILEMODIFY_NOTIFYSBJ;

$modversion['notification']['event'][3]['name']          = 'file_broken';
$modversion['notification']['event'][3]['category']      = 'global';
$modversion['notification']['event'][3]['admin_only']    = 1;
$modversion['notification']['event'][3]['title']         = _MI_XTORRENT_GLOBAL_FILEBROKEN_NOTIFY;
$modversion['notification']['event'][3]['caption']       = _MI_XTORRENT_GLOBAL_FILEBROKEN_NOTIFYCAP;
$modversion['notification']['event'][3]['description']   = _MI_XTORRENT_GLOBAL_FILEBROKEN_NOTIFYDSC;
$modversion['notification']['event'][3]['mail_template'] = 'global_filebroken_notify';
$modversion['notification']['event'][3]['mail_subject']  = _MI_XTORRENT_GLOBAL_FILEBROKEN_NOTIFYSBJ;
...
$modversion['notification']['event'][4]['title']         = _MI_XTORRENT_GLOBAL_FILESUBMIT_NOTIFY;
$modversion['notification']['event'][4]['caption']       = _MI_XTORRENT_GLOBAL_FILESUBMIT_NOTIFYCAP;
$modversion['notification']['event'][4]['description']   = _MI_XTORRENT_GLOBAL_FILESUBMIT_NOTIFYDSC;
$modversion['notification']['event'][4]['mail_template'] = 'global_filesubmit_notify';
$modversion['notification']['event'][4]['mail_subject']  = _MI_XTORRENT_GLOBAL_FILESUBMIT_NOTIFYSBJ;

$modversion['notification']['event'][5]['name']          = 'new_file';
$modversion['notification']['event'][5]['category']      = 'global';
$modversion['notification']['event'][5]['title']         = _MI_XTORRENT_GLOBAL_NEXTILE_NOTIFY;
$modversion['notification']['event'][5]['caption']       = _MI_XTORRENT_GLOBAL_NEXTILE_NOTIFYCAP;
$modversion['notification']['event'][5]['description']   = _MI_XTORRENT_GLOBAL_NEXTILE_NOTIFYDSC;
$modversion['notification']['event'][5]['mail_template'] = 'global_newfile_notify';
$modversion['notification']['event'][5]['mail_subject']  = _MI_XTORRENT_GLOBAL_NEXTILE_NOTIFYSBJ;
...
$modversion['notification']['event'][6]['title']         = _MI_XTORRENT_CATEGORY_FILESUBMIT_NOTIFY;
$modversion['notification']['event'][6]['caption']       = _MI_XTORRENT_CATEGORY_FILESUBMIT_NOTIFYCAP;
$modversion['notification']['event'][6]['description']   = _MI_XTORRENT_CATEGORY_FILESUBMIT_NOTIFYDSC;
$modversion['notification']['event'][6]['mail_template'] = 'category_filesubmit_notify';
$modversion['notification']['event'][6]['mail_subject']  = _MI_XTORRENT_CATEGORY_FILESUBMIT_NOTIFYSBJ;

$modversion['notification']['event'][7]['name']          = 'new_file';
$modversion['notification']['event'][7]['category']      = 'category';
$modversion['notification']['event'][7]['title']         = _MI_XTORRENT_CATEGORY_NEXTILE_NOTIFY;
$modversion['notification']['event'][7]['caption']       = _MI_XTORRENT_CATEGORY_NEXTILE_NOTIFYCAP;
$modversion['notification']['event'][7]['description']   = _MI_XTORRENT_CATEGORY_NEXTILE_NOTIFYDSC;
$modversion['notification']['event'][7]['mail_template'] = 'category_newfile_notify';
$modversion['notification']['event'][7]['mail_subject']  = _MI_XTORRENT_CATEGORY_NEXTILE_NOTIFYSBJ;
...
$modversion['notification']['event'][8]['title']         = _MI_XTORRENT_FILE_APPROVE_NOTIFY;
$modversion['notification']['event'][8]['caption']       = _MI_XTORRENT_FILE_APPROVE_NOTIFYCAP;
$modversion['notification']['event'][8]['description']   = _MI_XTORRENT_FILE_APPROVE_NOTIFYDSC;
$modversion['notification']['event'][8]['mail_template'] = 'file_approve_notify';
$modversion['notification']['event'][8]['mail_subject']  = _MI_XTORRENT_FILE_APPROVE_NOTIFYSBJ;
...
$modversion['notification']['event'][9]['title']         = '_MI_XTORRENT_COMPLETE_NOTIFY';
$modversion['notification']['event'][9]['caption']       = '_MI_XTORRENT_COMPLETE_NOTIFYCAP';
$modversion['notification']['event'][9]['description']   = '_MI_XTORRENT_COMPLETE_NOTIFYDSC';
$modversion['notification']['event'][9]['mail_template'] = 'completed_download_notify';
$modversion['notification']['event'][9]['mail_subject']  = '_MI_XTORRENT_COMPLETE_NOTIFYSBJ';

$modversion['notification']['event'][10]['name']          = 'completed';
$modversion['notification']['event'][10]['category']      = 'announce';
$modversion['notification']['event'][10]['title']         = '_MI_XTORRENT_COMPLETE_NOTIFY';
$modversion['notification']['event'][10]['caption']       = '_MI_XTORRENT_COMPLETE_NOTIFYCAP';
$modversion['notification']['event'][10]['description']   = '_MI_XTORRENT_COMPLETE_NOTIFYDSC';
$modversion['notification']['event'][10]['mail_template'] = 'completed_download_notify';
$modversion['notification']['event'][10]['mail_subject']  = '_MI_XTORRENT_COMPLETE_NOTIFYSBJ';
...
$modversion['notification']['event'][11]['title']         = '_MI_XTORRENT_STOPPED_NOTIFY';
$modversion['notification']['event'][11]['caption']       = '_MI_XTORRENT_STOPPED_NOTIFYCAP';
$modversion['notification']['event'][11]['description']   = '_MI_XTORRENT_STOPPED_NOTIFYDSC';
$modversion['notification']['event'][11]['mail_template'] = 'stopped_download_notify';
$modversion['notification']['event'][11]['mail_subject']  = '_MI_XTORRENT_STOPPED_NOTIFYSBJ';

$modversion['notification']['event'][12]['name']          = 'stopped';
$modversion['notification']['event'][12]['category']      = 'announce';
$modversion['notification']['event'][12]['title']         = '_MI_XTORRENT_STOPPED_NOTIFY';
$modversion['notification']['event'][12]['caption']       = '_MI_XTORRENT_STOPPED_NOTIFYCAP';
$modversion['notification']['event'][12]['description']   = '_MI_XTORRENT_STOPPED_NOTIFYDSC';
$modversion['notification']['event'][12]['mail_template'] = 'stopped_download_notify';
$modversion['notification']['event'][12]['mail_subject']  = '_MI_XTORRENT_STOPPED_NOTIFYSBJ';
