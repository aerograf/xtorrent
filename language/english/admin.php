...
define('_AM_XTORRENT_PRICEC', 'Price:');

define('_AM_XTORRENT_SOAP_CATEGORY', 'Categories on SOAP');
define('_AM_XTORRENT_SOAP_LISTING', 'Listing on SOAP');
define('_AM_XTORRENT_SOAP_RETRIEVE', 'Retrieve on SOAP');

define('_AM_XTORRENT_PAYMENTREG', 'Torrent Payment Register');
define('_AM_XTORRENT_PAYMENTS', 'Payment Register');
define('_AM_XTORRENT_PCONSOLID', 'Consolidate Payments');
...
define('_AM_XTORRENT_DBERROR', 'Database Access Error: Please report this error to the X-Torrent Website');
//Banned Users
...
define('_AM_XTORRENT_SNEXTILESVAL', 'Submitted:');
...
define('_AM_XTS_MVOTEDATA', 'Vote Data');
// waiting reviews
...
define('_AM_XTORRENT_MINDEX_PAGEINFOTXT', '
  <ul>
  <li>X-Torrent main page details.</li>
  <li>You can easily change the image logo, heading, main index header and footer text to suit your own look</li>
  </ul>
  <br><br>
  Note: The Logo image choosen will be used throughout X-Torrent.
  ');
...
define('_AM_XTORRENT_SUB_NEXTILECREATED', 'New File Data Created and Database Updated Successfully');
// Mimetypes
...
define('_AM_XTORRENT_FILE_CREATENEXTILE', 'Create New File');
...
define('_AM_XTORRENT_FILE_NEXTILEUPLOAD', 'New File Created and Database Updated Successfully');
...
//Add pr
define('_AM_XTORRENT_PAYPAL_IPN_UP', 'Update register with PayPal IPN');
define('_AM_XTORRENT_PAYPAL_IPN_RECORD', 'There are no new IPN records to import!');
define('_AM_XTORRENT_PAYPAL_IPN_IMPORT', 'IPN records have been imported for a total of $');
define('_AM_XTORRENT_PAYPAL_IPN_RECORDS', 'Number of new IPN records:');
define('_AM_XTORRENT_PAYPAL_IPN_TOTALING', 'Totaling $');
define('_AM_XTORRENT_PAYPAL_IPN_RECENT_1', 'This action will total up all recent PayPal IPN');
define('_AM_XTORRENT_PAYPAL_IPN_RECENT_2', 'transactions and post them here in the register.');
define('_AM_XTORRENT_PAYPAL_IPN_RECENT_3', 'Are you sure you want to do this now?');
define('_AM_XTORRENT_PAYPAL_IPN_DEL_1', 'Are you sure you want to delete this record?');
define('_AM_XTORRENT_PAYPAL_IPN_DATE', 'Date');
define('_AM_XTORRENT_PAYPAL_IPN_NUM', 'Num');
define('_AM_XTORRENT_PAYPAL_IPN_NAME', 'Name');
define('_AM_XTORRENT_PAYPAL_IPN_DESC', 'Description');
define('_AM_XTORRENT_PAYPAL_IPN_AMOUNT', 'Amount');
define('_AM_XTORRENT_PAYPAL_IPN_MODIFY', 'Modify');
define('_AM_XTORRENT_PAYPAL_IPN_FRE', 'FinRegEdit');
define('_AM_XTORRENT_PAYPAL_IPN_NB', 'Net Balance&nbsp;&nbsp;&nbsp;$');
