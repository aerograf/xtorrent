...
function rss_data($cid, $numitems)
{
	...
	$rss      = [];
  $result   = $xoopsDB->query("SELECT a.lid, a.cid, a.title, a.date, a.description, a.hits, a.version, a.platform, a.mirror, a.votes, a.publisher, a.updated, a.license, b.title as category FROM " . $xoopsDB->prefix('xtorrent_downloads'). " a INNER JOIN " . $xoopsDB->prefix('xtorrent_cat') . " b ON a.cid = b.cid $pif ORDER BY published DESC ", $numitems, 0);
	$rep      = ["<br>","<br/>","<br />"];
	$category = [];
