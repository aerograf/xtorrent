...
benc([type => "string", value => "spam"]) returns "4:spam".
benc([type => "integer", value => 3]) returns "i3e".
benc([type => "list", value => [
[type => "string", value => "spam"],
[type => "string", value => "eggs"]
]])
returns "l4:spam4:eggse"

benc([type => "dictionary", value => [
cow => [type => "string", value => "moo"],
spam => [type => "string", value => "eggs"],
]])
