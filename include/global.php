...
function format_quotes($s)
{
  while ($old_s != $s)
  {
	  ...
	  $quote = preg_replace(
	    ...
	    "<p class=sub><b>Quote:</b></p><table class=main style='border:1px;padding:10;'><tr><td style='border:1px black dotted'>\\1</td></tr></table><br>", $quote);

	  //[quote=Author]Text[/quote]
	  $quote = preg_replace(
	    "/\[quote=(.+?)\]\s*((\s|.)+?)\s*\[\/quote\]\s*/i",
	    "<p class=sub><b>\\1 wrote:</b></p><table class=main style='border:1px;padding:10;'><tr><td style='border:1px black dotted'>\\2</td></tr></table><br>", $quote);
...
function is_valid_id($id)
{
  ...
  {
    print("<table class=main style='width:750px;border:0;'>" .
  ...
  function begin_frame($caption = "", $center = false, $padding = 10)
  {
    ...
    print("<table style='width:100%;border:1px;padding:" . $padding . ";'><tr><td " . $tdextra . ">");
