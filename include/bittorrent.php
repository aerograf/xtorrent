...
?>
<table class=mainouter style=<?=$w; ?> border:1;>

<!------------- MENU ------------------------------------------------------------------------>

<? $fn = substr($PHP_SELF, strrpos($PHP_SELF, "/") + 1); ?>
<tr><td class=outer align=center>
<table class=main style="width:700px;border:0;">
<tr>

<td style="text-align:center;" class="navigation"><a href='index.php'>Home</a></td>
<td style="text-align:center;" class="navigation"><a href='browse.php'>Browse</a></td>
<td style="text-align:center;" class="navigation"><a href='upload.php'>Upload</a></td>
<? if (!$CURUSER) { ?>
<td style="text-align:center;" class="navigation">
<a href='login.php'>Login</a> / <a href='signup.php'>Signup</a>
</td>
<? } else { ?>
<td style="text-align:center;" class="navigation"><a href='my.php'>Profile</a></td>
<? } ?>
<td style="text-align:center;" class="navigation">Chat</td>
<td style="text-align:center;" class="navigation"><a href='forums.php'>Forums</a></td>
<td style="text-align:center;" class="navigation">DOX</td>
<td style="text-align:center;" class="navigation"><a href='topten.php'>Top 10</a></td>
<td style="text-align:center;" class="navigation"><a href='log.php'>Log</a></td>
<td style="text-align:center;" class="navigation"><a href='rules.php'>Rules</a></td>
<td style="text-align:center;" class="navigation"><a href='faq.php'>FAQ</a></td>
<td style="text-align:center;" class="navigation"><a href='links.php'>Links</a></td>
<td style="text-align:center;" class="navigation"><a href='staff.php'>Staff</a></td>
</tr>
</table>
</td>
</tr>
<tr><td class=outer style="text-align:center;padding-top:20px;padding-bottom:20px;">
<?
