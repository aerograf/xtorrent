...
else
{
	...
	if ('completed' == $event)
  {
	...
	if (isset($self))
	{
		$xoopsDB -> queryF('UPDATE '
                        ...
                        . ', to_go = '
                        . $left
                        . ", last_action = NOW(), seeder = '"
                        . $seeder
                        . "'"
                        . ('yes' == $seeder && $self['seeder'] != $seeder ? ', finishedat = '
                        . time() : '')
                        . ' WHERE '
                        . $selfwhere);
 ...
 $ret = $xoopsDB -> queryF('INSERT INTO '
                            . $xoopsDB->prefix('xtorrent_peers')
                            . " (connectable, torrent, peer_id, ip, port, uploaded, downloaded, to_go, started, last_action, seeder, userid, agent, uploadoffset, downloadoffset, passkey) VALUES ('"
                            . $connectable
                            . "', '"
                            . $torrentid
                            . "', "
