...
<div style="line-height: 12px;" class="even"><small><b><{$down.path}></b></small></div><br />
          ...
          <td valign="top" style="line-height: 12px;"> 
			...
			<div style="margin-left: 6px;">
				<a href="<{$xoops_url}>/modules/xtorrent/visit.php?cid=<{$down.cid}>&amp;lid=<{$down.id}>">
					<img src="<{$xoops_url}>/modules/xtorrent/assets/images/icons/32/downloads.gif" align="absmiddle" alt="" /> <{$smarty.const._MD_XTORRENT_DOWNLOADNOW}>
				</a> <{$down.adminlink}>
 			<{if $down.forumid > 0}>
  				<a href="<{$xoops_url}>/modules/newbb/viewforum.php?forum=<{$down.forumid}>">
					<img src="<{$xoops_url}>/modules/xtorrent/assets/images/icons/32/forum.gif" align="absmiddle" alt="<{$smarty.const._MD_XTORRENT_INFORUM}>" /> <{$smarty.const._MD_XTORRENT_INFORUM}>
				</a>
 			<{/if}>
			</div><br /><br /> 
...
<div align="justify"><b><{$smarty.const._MD_XTORRENT_HISTORY}></b><br />
            <{$down.history}></div> 
          <br /><{/if}></td> 
          <td width="35%" style="line-height: 12px;"><font color="#333333"> <div style="color:#000000; margin-left: 10px; margin-right: 10px; padding: 4px; background-color:#e6e6e6; border-color:#999999;" class="outer"> <small> 
            ...
            <br /> 
            <div style="margin-left: 10px; margin-right: 10px; padding: 4px;" class="outer"> <small><b><{$smarty.const._MD_XTORRENT_RATINGC}></b>&nbsp;<img src="<{$xoops_url}>/modules/xtorrent/assets/images/icons/32/<{$down.rateimg}>" alt="" align="absmiddle" />&nbsp;(<{$down.votes}>)</small></div> 
            <br />
            <div style="margin-left: 10px; margin-right: 10px; padding: 4px;" class="outer"> <small><b><{$smarty.const._MD_XTORRENT_REVIEWS}></b>&nbsp;<img src="<{$xoops_url}>/modules/xtorrent/assets/images/icons/32/<{$down.review_rateimg}>" alt="" align="absmiddle" />&nbsp;(<{$down.reviews_num}>)</small></div><br /> 
      ...
      <{/if}>        
        ...
        <tr> 
          <td colspan="2" class="even" style="line-height: 12px;"> <small> 
            <div align="center"> <a href="<{$xoops_url}>/modules/xtorrent/review.php?cid=<{$down.cid}>&amp;lid=<{$down.id}>"><{$smarty.const._MD_XTORRENT_REVIEWTHISFILE}></a> | <a href="<{$xoops_url}>/modules/xtorrent/ratefile.php?cid=<{$down.cid}>&amp;lid=<{$down.id}>"><{$smarty.const._MD_XTORRENT_RATETHISFILE}></a> | <{if $down.useradminlink == true}> <a href="<{$xoops_url}>/modules/xtorrent/modfile.php?lid=<{$down.id}>"><{$smarty.const._MD_XTORRENT_MODIFY}></a> | <{/if}> <a href="<{$xoops_url}>/modules/xtorrent/brokenfile.php?lid=<{$down.id}>"><{$smarty.const._MD_XTORRENT_REPORTBROKEN}></a> | <a target="_top" href="mailto:?subject=<{$down.mail_subject}>&amp;body=<{$down.mail_body}>"><{$smarty.const._MD_XTORRENT_TELLAFRIEND}></a> | <a href="<{$xoops_url}>/modules/xtorrent/singlefile.php?cid=<{$down.cid}>&amp;lid=<{$down.id}>"><{$smarty.const._COMMENTS}> (<{$down.comments}>)</a> </div> 
            </small> </td> 
        </tr> 
      </table> 
  </tr> 
...
<div style="padding: 3px; margin:3px;">
	<img src="<{$xoops_url}>/modules/xtorrent/assets/images/icons/32/reviews.gif" width="32" height="32" align="absmiddle" />
