...
<div align="justify"><b><{$smarty.const._MD_XTORRENT_HISTORY}></b><br />
          ...
          <td width="35%" style="line-height: 12px;"><font color="#333333"> <div style="color:#000000; margin-left: 10px; margin-right: 10px; padding: 4px; background-color:#e6e6e6; border-color:#999999;" class="outer"> <small> 
            ...
            <br /> 
            <div style="margin-left: 10px; margin-right: 10px; padding: 4px;" class="outer"> <small><b><{$smarty.const._MD_XTORRENT_RATINGC}></b>&nbsp;<img src="<{$xoops_url}>/modules/xtorrent/images/icon/<{$down.rateimg}>" alt="" align="absmiddle" />&nbsp;(<{$down.votes}>)</small></div> 
            <br />
            <div style="margin-left: 10px; margin-right: 10px; padding: 4px;" class="outer"> <small><b><{$smarty.const._MD_XTORRENT_REVIEWS}></b>&nbsp;<img src="<{$xoops_url}>/modules/xtorrent/images/icon/<{$down.review_rateimg}>" alt="" align="absmiddle" />&nbsp;(<{$down.reviews_num}>)</small></div><br /> 
