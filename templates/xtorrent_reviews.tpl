...
<h4><img src="<{$xoops_url}>/modules/xtorrent/assets/images/icons/32/reviews.gif" width="32" height="32" align="middle" /><{$smarty.const._MD_XTORRENT_TITLE}></h4>
...
<br />
<{if $navbar.navbar }>
<div class="odd"><b><{$smarty.const._MD_XTORRENT_PAGES}></b>: <{$navbar.navbar}></div><br />
<{/if}>
...
<tr>
<td bgcolor="#000000" colspan="2"><img src="/assets/images/blank.png" alt="" height="1" width="1" /></td>
</tr>
</table>

<table cellpadding="1" cellspacing="0" border="0">
<tr valign="top"><td width ="20%">
<div style="margin-left: 10px; margin-right: 10px; padding: 4px;"><b><{$smarty.const._MD_XTORRENT_RATEDRESOURCE}></b><br /><img src="<{$xoops_url}>/modules/xtorrent/assets/images/icons/32/<{$review.rated_img}>" alt="" align="middle" /></div> 
...
<br />
<{if $navbar.navbar }>
<div style="text-align: right;" class="odd"><b><{$smarty.const._MD_XTORRENT_PAGES}></b>: <{$navbar.navbar}></div><br />
<{/if}>
<!-- End ranking loop --> 
